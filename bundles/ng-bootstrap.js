...
var NgbDatepickerService = (function () {
    ...
    NgbDatepickerService.prototype.select = function (date, options) {
        ...
        if (!this._state.disabled) {
            ...
            if (options.emitEvent && datepicker_tools_1.isDateSelectable(this._state.months, validDate)) {
    ...
    NgbDatepickerService.prototype._updateState = function (patch) {
        ...
        if (startDate) {
            ...
            if ('selectedDate' in patch && state.selectedDate !== null) {
                if (!datepicker_tools_1.isDateSelectable(state.months, state.selectedDate)) {
